...
const WORD_BANKS: Record<Category, string[]> = {
  Food: [
    "Pizza","Burger","Pasta","Sandwich","Noodles","Rice","Bread","Cake",
  "Cookie","Chocolate","Ice Cream","Donut","Muffin","Pancake","Waffle",
  "Hot Dog","French Fries","Popcorn","Chicken","Egg","Omelette","Cheese",
  "Butter","Milk","Yogurt","Curd","Paneer","Soup","Salad","Apple",
  "Banana","Orange","Mango","Grapes","Watermelon","Pineapple","Strawberry",
  "Cherry","Peach","Pear","Kiwi","Lemon","Coconut","Avocado","Potato",
  "Tomato","Onion","Carrot","Cucumber","Peas","Corn","Beans","Spinach",
  "Cabbage","Cauliflower","Broccoli","Mushroom","Garlic","Ginger","Chili",
  "Pickle","Jam","Honey","Sugar","Salt","Pepper","Ketchup","Mustard",
  "Mayonnaise","Juice","Coffee","Tea","Milkshake","Smoothie","Soda","Water",
  "Biscuit","Cracker","Toast","Bagel","Cupcake","Brownie","Pie","Pudding",
  "Jelly","Candy","Lollipop","Gum","Chips","Nachos","Taco","Burrito",
  "Sushi","Dumpling","Spring Roll","Fried Rice","Biryani","Curry","Kebab",
  "Samosa","Pakora","Dosa","Idli","Paratha","Roti","Naan","Khichdi",
  "Upma","Poha","Pav Bhaji","Vada Pav","Pani Puri","Bhel Puri",
  "Rasgulla","Gulab Jamun","Jalebi","Laddu","Barfi","Kheer","Halwa",
  "Fish","Shrimp","Sausage","Ham","Bacon","Meatball","Stew","Porridge",
  "Oats","Cereal","Granola","Peanut Butter","Almond","Cashew","Walnut",
  "Pistachio","Raisin","Dates","Fig","Pumpkin","Zucchini","Beetroot",
  "Radish","Turnip","Lettuce","Olive","Nuggets","Wrap","Roll"
  ],
  Movies: [
  "Titanic","Avatar","Inception","Interstellar","Joker","The Dark Knight",
  "Batman","Superman","Spider-Man","Iron Man","Thor","Hulk","Avengers",
  "Black Panther","Doctor Strange","Frozen","Moana","Coco","Shrek",
  "Toy Story","Finding Nemo","The Lion King","Aladdin","Tangled",
  "Kung Fu Panda","Madagascar","Ice Age","Minions","Despicable Me",
  "The Matrix","John Wick","Mission Impossible","Top Gun","Gladiator",
  "The Godfather","Pulp Fiction","Fight Club","Forrest Gump",
  "The Shawshank Redemption","Jurassic Park","Jaws","King Kong",
  "Godzilla","Transformers","Pirates of the Caribbean",
  "Harry Potter","Fantastic Beasts","The Hobbit","The Lord of the Rings",
  "The Hunger Games","Twilight","The Notebook","La La Land",
  "Barbie","The Conjuring","Annabelle","Insidious","The Nun",
  "It","Scream","Saw","Final Destination","Get Out","Smile",
  "Home Alone","Jumanji","Deadpool","Venom","Logan","Rocky",
  "Creed","The Hangover","Whiplash","Her","The Martian",
  "Ready Player One","Tenet","Dune","Oppenheimer",

  // Bollywood
  "Sholay","DDLJ","3 Idiots","PK","Dangal","Lagaan",
  "Taare Zameen Par","Zindagi Na Milegi Dobara","Chak De India",
  "Bhool Bhulaiyaa","Bhool Bhulaiyaa 2","Kabir Singh","Animal",
  "Pushpa","RRR","Baahubali","Baahubali 2","KGF","KGF 2",
  "Drishyam","Drishyam 2","Singham","Sooryavanshi","War",
  "Pathaan","Jawan","Dhoom","Dhoom 2","Dhoom 3","Don",
  "Don 2","Krrish","Koi Mil Gaya","Ra One","Chennai Express",
  "Golmaal","Golmaal Again","Welcome","Hera Pheri","Phir Hera Pheri",
  "Housefull","Munna Bhai MBBS","Lage Raho Munna Bhai",
  "Bajrangi Bhaijaan","Sultan","Tiger Zinda Hai","Ek Tha Tiger",
  "Rockstar","Barfi","Yeh Jawaani Hai Deewani","Tamasha",
  "Wake Up Sid","Student of the Year","Kal Ho Naa Ho",
  "Kabhi Khushi Kabhie Gham","My Name Is Khan",
  "Om Shanti Om","Main Hoon Na","Dil Chahta Hai",
  "Andhadhun","Article 15","Queen","English Vinglish",
  "Stree","Stree 2","Tumbbad","Chhichhore",
  "The Kashmir Files","12th Fail","Super 30",
  "Uri","Kesari","Gully Boy","Gangubai Kathiawadi"
  ],
  Countries: [
     "India","United States","Canada","Mexico","Brazil","Argentina",
  "United Kingdom","France","Germany","Italy","Spain","Portugal",
  "Netherlands","Belgium","Switzerland","Austria","Sweden","Norway",
  "Finland","Denmark","Ireland","Poland","Greece","Turkey",
  "Russia","Ukraine","Czech Republic","Hungary","Romania","Croatia",

  "China","Japan","South Korea","North Korea","Thailand","Vietnam",
  "Indonesia","Malaysia","Singapore","Philippines","Pakistan",
  "Bangladesh","Sri Lanka","Nepal","Bhutan","Myanmar","Mongolia",
  "Taiwan","Hong Kong","Cambodia","Laos",

  "Australia","New Zealand","Fiji","Papua New Guinea",

  "South Africa","Nigeria","Kenya","Egypt","Morocco","Algeria",
  "Tunisia","Ghana","Ethiopia","Uganda","Tanzania","Zimbabwe",

  "Saudi Arabia","United Arab Emirates","Qatar","Kuwait","Bahrain",
  "Oman","Yemen","Iran","Iraq","Israel","Jordan","Lebanon","Syria",

  "Chile","Colombia","Peru","Venezuela","Ecuador","Bolivia",
  "Paraguay","Uruguay","Cuba","Jamaica","Dominican Republic",
  "Costa Rica","Panama","Guatemala","Honduras","El Salvador",

  "Iceland","Luxembourg","Slovakia","Slovenia","Serbia",
  "Bosnia","Lithuania","Latvia","Estonia","Belarus"
  ],
  Celebrities: [
  "Shah Rukh Khan","Salman Khan","Aamir Khan","Hrithik Roshan",
  "Ranbir Kapoor","Ranveer Singh","Akshay Kumar","Ajay Devgn",
  "Amitabh Bachchan","Rajinikanth","Prabhas","Allu Arjun",
  "Jr NTR","Ram Charan","Yash","Kamal Haasan",
  "Deepika Padukone","Alia Bhatt","Katrina Kaif","Priyanka Chopra",
  "Kareena Kapoor","Kiara Advani","Shraddha Kapoor","Anushka Sharma",
  "Aishwarya Rai","Madhuri Dixit","Sridevi","Rashmika Mandanna",
  "Samantha Ruth Prabhu","Nayanthara",
  ...
  "Usain Bolt","Serena Williams","Simone Biles",

  "Elon Musk","Bill Gates","Mark Zuckerberg","Jeff Bezos",
  "Steve Jobs","Sundar Pichai","Satya Nadella","Sam Altman",
  "Warren Buffett","Larry Page",

  "Taylor Swift","Ed Sheeran","Justin Bieber","Drake",
  "Ariana Grande","Selena Gomez","Rihanna","Beyonce",
  "Lady Gaga","Bruno Mars","The Weeknd","Billie Eilish",
  "Dua Lipa","Shakira","Bad Bunny","Harry Styles",
  "BTS","Jungkook","Blackpink","Lisa",

  "Tom Cruise","Leonardo DiCaprio","Brad Pitt","Johnny Depp",
  "Will Smith","Dwayne Johnson","Keanu Reeves","Ryan Reynolds",
  "Robert Downey Jr","Chris Hemsworth","Chris Evans",
  "Tom Holland","Andrew Garfield","Zendaya","Emma Watson",
  "Jennifer Lawrence","Margot Robbie","Scarlett Johansson",
  "Anne Hathaway","Morgan Freeman",

  "MrBeast","PewDiePie","KSI","Logan Paul",
  "CarryMinati","Bhuvan Bam","Ashish Chanchlani",
  "Technical Guruji","Triggered Insaan","Flying Beast"
  ],
  Sports: [
    "Football","Cricket","Basketball","Tennis","Badminton","Volleyball",
  "Baseball","Rugby","Hockey","Golf","Boxing","Wrestling",
  "Table Tennis","Swimming","Cycling","Athletics","Marathon","Running",
  "High Jump","Long Jump","Shot Put","Javelin","Archery","Fencing",
  "Gymnastics","Karate","Judo","Taekwondo","Kickboxing","MMA",
  "Formula 1","MotoGP","Racing","Skateboarding","Surfing","Skiing",
  "Snowboarding","Bobsleigh","Curling","Ice Hockey","Figure Skating",
  "Chess","Poker","Esports","Kabaddi","Kho Kho","Polo",
  "Shooting","Rowing","Canoeing","Kayaking","Sailing","Diving",

  "World Cup","Olympics","IPL","Champions League","Premier League",
  "La Liga","Serie A","Bundesliga","Wimbledon","US Open",
  "French Open","Australian Open","Super Bowl","NBA","FIFA",
  "ICC","Asian Games","Commonwealth Games","UEFA","Copa America",

  "Virat Kohli","MS Dhoni","Sachin Tendulkar","Rohit Sharma",
  "Jasprit Bumrah","Hardik Pandya","Ravindra Jadeja","Yuvraj Singh",
  "Cristiano Ronaldo","Lionel Messi","Neymar","Kylian Mbappe",
  "Erling Haaland","Mohamed Salah","Kevin De Bruyne",
  "LeBron James","Stephen Curry","Michael Jordan","Kobe Bryant",
  "Roger Federer","Rafael Nadal","Novak Djokovic","Carlos Alcaraz",
  "Serena Williams","Iga Swiatek","PV Sindhu","Saina Nehwal",
  "Neeraj Chopra","Usain Bolt","Simone Biles","Tiger Woods",
  "Max Verstappen","Lewis Hamilton","Valentino Rossi",
  "Conor McGregor","Khabib Nurmagomedov","Mike Tyson",
  "Muhammad Ali","The Undertaker","John Cena",
  "Magnus Carlsen","Viswanathan Anand"
  ],
  Technology: [
    "iPhone","Android","Samsung","Google","YouTube","Instagram",
  "Facebook","WhatsApp","Twitter","TikTok","Snapchat","LinkedIn",
  "Reddit","Discord","Telegram","Spotify","Netflix","Amazon",
  "Flipkart","Myntra","Uber","Ola","Zomato","Swiggy",
  "Paytm","PhonePe","Google Pay","PayPal","ChatGPT","OpenAI",
  "Gemini","Claude","Copilot","DeepSeek","Perplexity","Midjourney",
  "Grok","Meta AI","Cursor","Notion","Slack","Zoom",
  "Microsoft","Apple","Meta","Tesla","SpaceX","Intel",
  "AMD","NVIDIA","Qualcomm","Cisco","Oracle","IBM",
  "GitHub","Git","VS Code","Figma","Canva","Photoshop",
  "Illustrator","Chrome","Firefox","Safari","Edge","Opera",
  "Windows","macOS","Linux","Ubuntu","Android Studio","Xcode",
  "React","Next.js","Node.js","MongoDB","MySQL","PostgreSQL",
  "Firebase","Supabase","Docker","Kubernetes","Vercel","Netlify",
  "AWS","Azure","Google Cloud","Blockchain","Bitcoin","Ethereum",
  "NFT","PlayStation","Xbox","Nintendo","Steam","VR",
  "AR","Smartwatch","Laptop","Keyboard"
  ],
}
